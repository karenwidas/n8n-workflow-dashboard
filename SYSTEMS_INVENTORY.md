...
**Last updated:** 2026-05-18 — added eula, privacy-policy, merchant-form, decrypt-tool, icons/preview, email templates to repo section; added 3 n8n exports; removed missing leads/quote-builder
...
| `leads/decrypt-tool.html` | Tool for decrypting encrypted merchant form data |
| `eula.html` | End User License Agreement page |
| `privacy-policy.html` | Privacy policy page |
| `icons/preview.html` | Icon set preview / reference utility |
| `email-date-request.html` | FM season date request email template |
| `email-remove-hold.html` | FM seasonal hold removal email template |
| `email-close-account.html` | FM account close email template |
...
| `n8n/crm/convert-lead.json` | Convert CRM lead to merchant account |
