...
**Last updated:** 2026-05-11 — added merchant-form, decrypt-tool, eula, privacy-policy, icons/preview, email templates; removed quote-builder (file gone); added merchant-form-submit, convert-lead, send-form n8n exports
...
| `leads/merchant-form.html` | Merchant application / onboarding form for leads |
| `leads/decrypt-tool.html` | Decrypt tool for merchant form submissions |
| `eula.html` | End user license agreement page |
| `privacy-policy.html` | Privacy policy page |
| `icons/preview.html` | Icon set preview |
...
| `email-close-account.html` | FM email template — close FM account (internal) |
...
| `n8n/crm/send-form.json` | Send merchant application form to lead |
| `n8n/crm/merchant-form-submit.json` | Handle merchant form submission |
| `n8n/crm/convert-lead.json` | Convert lead to active merchant account |
