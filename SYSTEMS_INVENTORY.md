...
**Last updated:** 2026-04-20 — added leads/merchant-form, leads/decrypt-tool, privacy-policy, eula to repo section; added 3 n8n CRM workflow exports (merchant-form-submit, send-form, convert-lead); removed quote-builder (not found on disk); PWA path fixes noted
...
| `leads/decrypt-tool.html` | Internal tool to decrypt merchant form submissions |
| `privacy-policy.html` | Privacy policy page (linked from merchant form app) |
| `eula.html` | EULA page (linked from merchant form app) |
| `email-date-request.html` | FM season date-request email template |
| `email-remove-hold.html` | FM remove-hold email template (internal) |
| `email-close-account.html` | FM close-account email template (internal) |
...
| `n8n/crm/convert-lead.json` | Convert CRM lead to active merchant account |
